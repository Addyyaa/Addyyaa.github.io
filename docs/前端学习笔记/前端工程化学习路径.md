...
>
> ![image-20250315230431650](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20250315230431650.png)
>
> `<colgroup>` 元素定义了表格中的一组列。
>
> `<data>` 将一个指定内容和机器可读的翻译联系在一起。但是，如果内容是与时间或者日期相关的，则一定要使用`<time>`。
>
> ![image-20250315230950187](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20250315230950187.png)
>
